...
and that the method in the MovieTicketServer class could not be run simultaneously. Also if 
there was no more tickets left, the users would be notified about it when they tried to book 
